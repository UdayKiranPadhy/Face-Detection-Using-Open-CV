...
videoStreamObject.set(3,1280)
videoStreamObject.set(4,720)
...
while videoStreamObject .isOpened():
    ...
    if ret and frame is not None:
        ...
        # If "q"(quit) is pressed just simpily break the loop 
        if k == ord('q'):
            break
...
# Release all the resources by the video object
videoStreamObject.release()

# Close all the windows and threads created by cv2
